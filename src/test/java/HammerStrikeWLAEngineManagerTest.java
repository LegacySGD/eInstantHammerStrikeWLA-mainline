...
public class HammerStrikeWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HammerStrikeWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HammerStrikeWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HammerStrikeWLAIW/InitOutcome.xml").getDocumentElement();
